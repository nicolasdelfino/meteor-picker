...
//             Meteor.call('updateMatrix', Session.get('activeGame'), tileIndex, "x", function(error, success) {
//                 if (success) {
//                     // updateBoard();
...
//             Meteor.call('updateMatrix', Session.get('activeGame'), tileIndex, "o", function(error, success) {
//                 if (success) {
//                     // updateBoard();
//                     console.log("update success");
//                     removePop();
